...
class FreeTrialResultsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final netScore = correctCount - (wrongCount / 4);
    final score = ((correctCount / totalQuestions) * 100).toStringAsFixed(1);

    return Scaffold(
      appBar: AppBar(
        title: Text('${testTitle.toUpperCase()} RESULTS'),
        ...
        actions: [
          IconButton(
            icon: Icon(
              ...
              color: isDark ? Colors.yellow : testColor,
            ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Net Score: ${netScore.toStringAsFixed(2)}',
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 20,
                              fontWeight: FontWeight.w600,
