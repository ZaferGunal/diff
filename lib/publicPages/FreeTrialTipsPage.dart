...
import 'package:untitled5/TILPages/TILPhysicsLearningPage.dart';
import 'package:untitled5/TILPages/TILTechnicalLearningPage.dart';
...
class _LearningHallState extends State<LearningHall> {
  final List<Map<String, dynamic>> subjects = [
    ...
    },
    {
      ...
      'description': 'Classical Mechanics & Energy',
      'topics': 'Vectors • Forces • Circuits',
      'isNew': true,
    },
    {
                        ...
                        onTap: () {
                          if (subject['title'] == 'Physics') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TILPhysicsLearningPage(
                                  toggleTheme: widget.toggleTheme ?? () {},
                                ),
                              ),
                            );
                          } else if (subject['title'] == 'Technical Knowledge') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TILTechnicalLearningPage(
                                  toggleTheme: widget.toggleTheme ?? () {},
                                ),
                              ),
                            );
