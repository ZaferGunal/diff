...
class BocconiPurchasePage extends StatefulWidget {
  ...
  @override
  State<BocconiPurchasePage> createState() => _BocconiPurchasePageState();
}

class _BocconiPurchasePageState extends State<BocconiPurchasePage> {
  ...
  Future<void> _handlePurchase() async {
    ...
    try {
      ...
      print('🔍 [BOCCONI PURCHASE] Initializing payment for user: $userId');

      final response = await AuthService().initializeBocconiPayment(
        userId: userId,
        email: userEmail,
        name: userName,
      ...
      if (response != null && response.data['success'] == true) {
        ...
        if (paymentUrl != null) {
          print('✅ [BOCCONI] Opening payment URL');

          final uri = Uri.parse(paymentUrl);
          await launchUrl(uri, mode: LaunchMode.externalApplication);

          // ✅ Ödeme kontrolünü başlat
  ...
  void _startPaymentPolling(String userId) {
    ...
    _pollTimer = Timer.periodic(Duration(seconds: 3), (timer) async {
      try {
        ...
        if (response != null && response.data['success'] == true) {
          final hasBocconi = response.data['hasBocconiPackage'] ?? false;
          ...
          if (hasBocconi) {
            ...
            if (mounted) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('🎉 Payment successful! Welcome to Bocconi!'),
                  backgroundColor: MyColors.green,
                ),
              );
            }
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        _buildSummaryRow('Package', 'Bocconi Exam Preparation', isDark),
                        _buildSummaryRow('Access', 'Lifetime', isDark),
