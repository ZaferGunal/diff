                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Icon(
                                                  isEmpty ? Icons.remove_circle : Icons.close,
                                                  color: isEmpty ? Colors.orange : Colors.red,
                                                  size: 20,
                                                ),
                                                const SizedBox(width: 8),
                                                Text(
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: isDark ? const Color(0xFF1a1f37) : Colors.white,
