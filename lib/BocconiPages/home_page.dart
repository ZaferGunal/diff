...
import 'package:untitled5/BocconiPages/practicePastResultsPage.dart';

import '../MainPages/Dashboard.dart';
import '../UserProvider.dart';
import '../MyColors.dart';
import '../publicPages/FreeTrialTipsPage.dart';
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  void _checkSessionStatus() {
    ...
    if (authProvider.token == null) {
      print("❌ [HomePage] No token - redirecting to Dashboard");
    ...
    return Consumer<AuthProvider>(
      builder: (context, authProvider, child) {
        if (_hasCheckedSession && authProvider.token == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            print("❌ [HomePage] Session expired - going to Dashboard");
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => DashboardPage(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                // ✅ Back to Dashboard Button - Visible and Prominent
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: MyColors.bocco_blue.withOpacity(0.3),
                                        blurRadius: 8,
                                        offset: const Offset(0, 2),
                                      ),
                                    ],
